    ...
    static {
        ...
        try {
            if ( LOCAL_VERSION.lessThanOrEqualTo( MinecraftVersion.v1_17 ) ) {
                ...
                methodCache.put( "get", Objects.requireNonNull(getNMSClass("NBTTagCompound")).getMethod( "c", String.class ) );
                methodCache.put( "set", Objects.requireNonNull(getNMSClass("NBTTagCompound")).getMethod( "a", String.class, getNMSClass( "NBTBase" ) ) );
                methodCache.put( "hasKey", Objects.requireNonNull(getNMSClass("NBTTagCompound")).getMethod( "e", String.class ) );
            }
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_18_R1 ) ) {
                methodCache.put( "setIndex", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "d", int.class, getNMSClass( "NBTBase" ) ) );
            } else if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_17 ) ) {
                methodCache.put( "setIndex", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "set", int.class, getNMSClass( "NBTBase" ) ) );
            } else {
                methodCache.put( "setIndex", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "a", int.class, getNMSClass( "NBTBase" ) ) );
            }
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_18_R1 ) ) {
                methodCache.put( "add", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "c", int.class, getNMSClass( "NBTBase" ) ) );
            } else if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_14 ) ) {
                methodCache.put( "add", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "add", int.class, getNMSClass( "NBTBase" ) ) );
            } else {
                methodCache.put( "add", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "add", getNMSClass( "NBTBase" ) ) );
            }
            methodCache.put( "size", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "size" ) );

            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_18_R1 ) ) {
                methodCache.put( "listRemove", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "c", int.class )  );
            } else if ( LOCAL_VERSION == MinecraftVersion.v1_8 ) {
                methodCache.put( "listRemove", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "a", int.class )  );
            } else {
                methodCache.put( "listRemove", Objects.requireNonNull(getNMSClass("NBTTagList")).getMethod( "remove", int.class )  );
            }
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_18_R1 ) ) {
        ...
        try {
            if ( LOCAL_VERSION.lessThanOrEqualTo( MinecraftVersion.v1_16 ) ) {
                ...
                NBTListData = Objects.requireNonNull(getNMSClass("NBTTagList")).getDeclaredField( "c" );
                NBTCompoundMap = Objects.requireNonNull(getNMSClass("NBTTagCompound")).getDeclaredField( "x" );
            }
